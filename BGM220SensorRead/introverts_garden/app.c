...
//      app_log_status_error(sc);
    ...
    case sl_bt_evt_gatt_server_attribute_value_id:
         ...
         if (gattdb_pump_control == evt->data.evt_gatt_server_characteristic_status.characteristic) {
           uint8_t data_recv;
           size_t data_recv_len;

           // Read characteristic value.
           sc = sl_bt_gatt_server_read_attribute_value(gattdb_pump_control,
                                                       0,
                                                       sizeof(data_recv),
                                                       &data_recv_len,
                                                       &data_recv);
    ...
    case sl_bt_evt_gatt_server_characteristic_status_id:
      sc = send_sensor_data_notification(evt);
      app_log_status_error(sc);
      break;
